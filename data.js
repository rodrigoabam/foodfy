module.exports = [
    {
        ...
        ingredients: [
            ...
            { name: "1 ovo;" },
            { name: "3 colheres (sopa) de farinha de trigo;" },
            { name: "3 colheres (sopa) de tempero caseiro: feito com alho, sal, cebola, pimenta e cheiro verde processados no liquidificador;" },
            { name: "30 ml de água gelada;" }
        ],
        preparation: [
            { step: "1º passo" },
            { step: "2º passo" },
    ...
    },
    {
        ...
        ingredients: [
            ...
            { name: "100 g de semolina, caso não encontrar semolina, pode ser 100 gramas de farinha de trigo mesmo.;" },
            { name: "1 sachê de 10g de fermento biológico seco;" },
            { name: "1/2 colher de sopa de sal;" },
            { name: "1/2 colher de sopa de açúcar cristal;" }
        ],
        preparation: [
            { step: "1º passo" },
            { step: "2º passo" },
    ...
    },
    {
        ...
        ingredients: [
            ...
            { name: "5 dentes de alho grandes;" },
            { name: "1 xícara (chá) de azeite;" },
            { name: "1 pimenta dedo-de-moça inteira;" },
        ],
        preparation: [
            { step: "1º passo" },
            { step: "2º passo" },
    ...
    },
    {
        ...
        ingredients: [
            ...
            { name: "100 g de farinha de trigo;" },
            { name: "150 g de queijo parmesão;" },
            { name: "100 g de queijo emmental;" },
            { name: "150 g de queijo cheddar;" },
            { name: "100 g farinha Panko;" },
            { name: "Noz moscada a gosto;" },
            { name: "Sal e pimenta do reino preta a gosto;" }
        ],
        preparation: [
            { step: "1º passo" },
            { step: "2º passo" },
    ...
    },
    {
        ...
        ingredients: [
            ...
            { name: "Pitada de raspas de limão;" },
            { name: "4 colheres (sopa) de orégano;" },
            { name: "2 colheres (sopa) de páprica doce em pó;" },
            { name: "4 colheres (sopa) de molho barbecue;" },
            { name: "5 dentes de alho triturados;" },
            { name: "Pimenta do reino e sal a gosto;" },
            { name: "4 colheres (sopa) de azeite;" },
            { name: "Bastante molho barbecue para pincelar;" }
        ],
        preparation: [
            { step: "1º passo" },
            { step: "2º passo" },
        ...
        infos: "Churrasquinho com a asinha de frango bem temperadinha e crocante coberta com molho de barbecue.  Receita deliciosa que fez o maior sucesso entre os amigos e familiares preparado pelo “marido chef”. Teste essa delícia!"
    }
]